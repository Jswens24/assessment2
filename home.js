...
console.log(canWeDeliverTwo(84115));
...
//CODE HERE
const markDown = deals[0].title.replace('15', '10');
...
const dealExtended = deals[1].desc.replace('March', 'April').trim();

console.log(dealExtended);